...
Ravencoin.prototype.getAddressSummary = function(addressArg, options, callback) {
  ...
  function querySummary() {
    async.parallel([
      ...
      function getAssets(done) {
        self.listAssetBalancesByAddress(addresses, options, function(err, data) {
          if (err) {
            return done(err);
          }
          summary.assets = data;
 ...
 * @param {Function} callback
 */
Ravencoin.prototype.listAssets = function(callback) {
   var self = this;
   this.client.listAssets(function(err, response) {
  	 if (err) {
  			return callback(self._wrapRPCError(err));
   	 }
   	 var result = response.result;
 ...
 * @param {Function} callback
 */
Ravencoin.prototype.listAssetBalancesByAddress = function(address, callback) {
   var self = this;
   this.client.listAssetBalancesByAddress(address, function(err, response) {
  	 if (err) {
  			return callback(self._wrapRPCError(err));
   	 }
   	 var result = response.result;
 ...
 * @param {Function} callback
 */
Ravencoin.prototype.listAddressesByAsset = function(asset, callback) {
   var self = this;
   this.client.listAddressesByAsset(asset, function(err, response) {
  	 if (err) {
  			return callback(self._wrapRPCError(err));
   	 }
   	 var result = response.result;
  ...
  * @param {Function} callback
  */
Ravencoin.prototype.getAssetData = function(asset, callback) {
    var self = this;
    this.client.getAssetData(asset, function(err, response) {
		if (err) {
			return callback(self._wrapRPCError(err));
		}
		var result = response.result;
    var ipfsHash = null;
    if (result.has_ipfs == 1) {
